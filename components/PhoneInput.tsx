  ...
  return (
    <div className={`relative ${wrapperClassName}`} ref={wrapperRef}>
      ...
      {dropdownOpen && !fixedCountry && (
        <div className="absolute z-50 top-full left-0 mt-1 bg-white rounded-xl shadow-card border border-divider overflow-hidden min-w-[220px]">
          {COUNTRY_LIST.map(c => {
            ...
            return (
              ...
              >
                ...
                <span className="flex-1">{locale === 'fr' ? c.nameFr : c.name}</span>
